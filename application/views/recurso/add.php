<?php echo form_open('recurso/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="nombreTema" value="<?php echo $this->input->post('nombreTema'); ?>" class="form-control" id="nombreTema" />
